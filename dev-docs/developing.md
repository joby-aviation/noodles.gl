...
- **Never use `constructor.name`** - it gets minified in production builds. Use static `displayName`/`description` properties and access them via `(operator.constructor as typeof Operator).displayName`
