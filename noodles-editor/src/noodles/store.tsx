...
// Returns undefined during race conditions (e.g., when renaming nodes) instead of throwing
// to prevent crashes when ReactFlow's nodes array hasn't updated yet
export const useOp = (id: OpId): Operator<IOperator> | undefined => {
