...
export const BASEMAP_CATALOG: BasemapEntry[] = [
  ...
  {
    name: 'Light',
    url: 'https://tiles.protomaps.com/styles/light.json',
    provider: 'Protomaps',
    category: 'light',
    type: 'vector',
    labels: true,
  ...
  {
    name: 'Dark',
    url: 'https://tiles.protomaps.com/styles/dark.json',
    provider: 'Protomaps',
    category: 'dark',
    type: 'vector',
    labels: true,
  ...
  {
    name: 'White',
    url: 'https://tiles.protomaps.com/styles/white.json',
    provider: 'Protomaps',
    category: 'light',
    type: 'vector',
    labels: true,
  ...
  {
    name: 'Black',
    url: 'https://tiles.protomaps.com/styles/black.json',
    provider: 'Protomaps',
    category: 'dark',
    type: 'vector',
    labels: false,
  ...
  {
    name: 'Grayscale',
    url: 'https://tiles.protomaps.com/styles/grayscale.json',
    provider: 'Protomaps',
    category: 'light',
    type: 'vector',
    labels: true,
  ...
  {
    name: 'Earth at Night',
    url: 'https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/VIIRS_CityLights_2012/default/2012-04-01/EPSG3857_500m/{z}/{y}/{x}.jpeg',
    provider: 'NASA',
    category: 'imagery',
    type: 'raster',
    labels: false,
